...
export const AccordionIcon = () => {
    return (
        <svg version="1.1" id="Capa_1" height="30px" width="30px" xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink" x="0px" y="0px"
            viewBox="0 0 297.005 297.005" style={{ background: "new 0 0 297.005 297.005" }} xmlSpace="preserve">
            <g>
           ...
           c-2.543,4.405-1.034,10.037,3.371,12.58l3.342,1.93C175.169,210.239,175.269,210.03,175.386,209.827z"/>
                ...
                <rect x="40.288" y="102.421" transform="matrix(0.5 0.866 -0.866 0.5 126.5375 21.3415)" style={{ fill: "#2B2B2B" }} width="8.997" height="35.666" />

                <rect x="49.64" y="118.968" transform="matrix(0.5 0.866 -0.866 0.5 145.5429 21.5166)" style={{ fill: "#2B2B2B" }} width="8.997" height="35.666" />

                <rect x="58.991" y="135.514" transform="matrix(0.5 0.866 -0.866 0.5 164.5484 21.6917)" style={{ fill: "#2B2B2B" }} width="8.997" height="35.666" />

                <rect x="71.526" y="157.28" transform="matrix(0.5 0.866 -0.866 0.5 189.6656 21.7188)" style={{ fill: "#2B2B2B" }} width="8.997" height="35.666" />

                <rect x="81.683" y="174.36" transform="matrix(0.5 0.866 -0.866 0.5 209.5366 21.4628)" style={{ fill: "#2B2B2B" }} width="8.997" height="35.666" />
            </g>
            <g>
            </g>
            <g>
